...
use zero2prod::aggregates::subscriber::domain::infrastructure::SubscriberRepository;
use zero2prod::aggregates::subscriber::domain::infrastructure::SubscriptionTokenRepository;
...
use crate::aggregates::subscriber::domain::command::confirm_subscription_command as command;
use crate::aggregates::subscriber::domain::command::confirm_subscription_command;
use crate::aggregates::subscriber::domain::model::subscriber;
use crate::aggregates::subscriber::domain::model::subscription_token;
